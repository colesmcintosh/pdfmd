...
fn lookup(name: &str) -> Option<&'static str> {
    Some(match name {
        ...
        "asterisk" => "*", "plus" => "+", "comma" => ",",
        "hyphen" => "-", "minus" => "\u{2212}", "period" => ".", "slash" => "/",
        "colon" => ":", "semicolon" => ";",
        ...
        "acute" => "\u{00B4}", "mu" => "\u{03BC}", "paragraph" => "\u{00B6}",
        "periodcentered" => "\u{00B7}", "cedilla" => "\u{00B8}",
        "onesuperior" => "\u{00B9}", "ordmasculine" => "\u{00BA}",
        "guillemotright" => "\u{00BB}",
        "onequarter" => "\u{00BC}", "onehalf" => "\u{00BD}", "threequarters" => "\u{00BE}",
        "questiondown" => "\u{00BF}",
        ...
        "Egrave" => "\u{00C8}", "Eacute" => "\u{00C9}", "Ecircumflex" => "\u{00CA}",
        "Edieresis" => "\u{00CB}", "Igrave" => "\u{00CC}", "Iacute" => "\u{00CD}",
        "Icircumflex" => "\u{00CE}", "Idieresis" => "\u{00CF}",
        "Eth" => "\u{00D0}", "Ntilde" => "\u{00D1}", "Ograve" => "\u{00D2}",
        "Oacute" => "\u{00D3}", "Ocircumflex" => "\u{00D4}", "Otilde" => "\u{00D5}",
        "Odieresis" => "\u{00D6}", "multiply" => "\u{00D7}", "Oslash" => "\u{00D8}",
        ...
        "theta1" => "\u{03D1}", "phi1" => "\u{03D5}", "omega1" => "\u{03D6}",
        "sigma1" => "\u{03C2}",

        // Math operators that show up in our sample paper
        "summation" => "\u{2211}", "product" => "\u{220F}", "integral" => "\u{222B}",
        "partialdiff" => "\u{2202}", "radical" => "\u{221A}", "infinity" => "\u{221E}",
